...
**Script:** "For 1,000 agents at $100/agent/month that's $1.2M ARR - less than one breach, less than one failed SOX audit, less than one FTE dedicated to manual agent cleanup. Most customers see 5-10x ROI in the first year from: unblocked AI productivity (the CIO/CEO value), reduced audit findings (the CISO value), and FTE savings on manual cleanup (the operational value). The orphan agent that triggers a breach will cost orders of magnitude more than the annual contract."
