...
*Single source of truth for all external communications, sales, website, decks, and content*

---

## Category We Own

**Human-Lineage Agent Governance** (or "Org-Chart-Native Agent Identity Governance")
...
- **CISO-focused:** "Stop the agent sprawl before your auditor does."
...
- Speak like the smartest person in the room who still has a sense of humor
- Use "we" when talking about the industry problem ("We've all seen the orphan agent list...")
- Be direct about competitors ("Entra Agent ID is great for identity. It still needs Pedigree for governance.")
...
**Don't Say:**
- "Shadow" anything (negative, compliance-triggering)
...
2. The Thesis (org chart visual)
3. How It Works (5-layer animated diagram)
4. Why Pedigree Wins (moat + 2026 timing)
5. Customer Story (Wesco quote + metrics)
6. Pricing teaser + CTA

---

*See also: [Competitive Analysis](./competitive.md) | [Objection Handling](./objections.md) | [Deck](./deck.md)*
